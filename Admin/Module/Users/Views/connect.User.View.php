<div id="connexion" style="text-align: center"><br><br>
    ...
    <form action="../Admin/Module/users/Controller/connect.User.Ctrl.php" method="post" style="width: 30%; margin-left: 36%">

        <label ><u>user</u></label><br>
        <input type="text" class="form-control"  name="user" style="text-align: center; <?php if (isset($_SESSION["err_user"])){ echo 'border-color: red ';} ?>"><br><br>

        <label ><u>pass</u></label><br>
        <input type="password" class="form-control" name="pass" style="text-align: center; <?php if (isset($_SESSION["err_pass"])){ echo 'border-color: red ';} ?>"><br><br>
