...
if (Module\Activate_module::get_Activate_module('blog') == 'yes') {
    ...
    <div id="blog" class="row">
        ...
        <div id="Card_View" class="col-md-9" >
            ...
            <?php $article = \Module\Blog\Database\Database::getBdd()->Select_Article($_GET["id"]) ?>
            ...
            <div class="col-md-12">
                <div class="Card">
                    ...
                    <div class="Card_img" style="text-align: center">
                    ...
                    <div class="Card_description">
                        ...
                        <br><br><span><a href="index.php?p=Blog"><button class="btn btn-primary">retour</button></a></span><span class="Card_autor">auteur : <?= $article["autor"] ?></span><br><br>
